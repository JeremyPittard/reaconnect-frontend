  ...
  return (
    <section className="mt-40 max-w-3xl mx-auto">
      <h1 className="text-3xl">
        {`
        At Copy Ipsum, we believe that many real estate assets are "always for
        sale" or "always on the market" for the right price, even if they aren't
        listed publicly.
      `}
      </h1>
      <p>
        ...
        home or rental property. Join Copy Ipsum today and start your search!
        `}
      </p>
    </section>
  );
