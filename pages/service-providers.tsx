...
export default function ServiceProviders() {
  return (
    <>
      <Layout>
        <Head>
          <title>ReaConnect | Service Provider Opportunities </title>
          <meta
            name="description"
        ...
        >
          ...
          <p>
            We at Reaconnect are interested in exploring models and agreements
            to disrupt the current transactional methods that exist in the real
            estate market. Our aim is to enable a ‘fairer go’ for both
            homeowners and buyers / renters.
          </p>
        </motion.section>
