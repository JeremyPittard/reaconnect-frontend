...
export default function Investors() {
  return (
    <>
      <Head>
        <title>ReaConnect | Investment Opportunities </title>
        <meta
          name="description"
      ...
      <Layout>
        ...
        >
          ...
          <p>
            ...
            where potential buyers/renters and real estate agents write letters
            to homeowners that relay their interests in a property. This is to
            buy or rent a specific property or a narrow suburb range of
          ...
          <p>
            ...
            can be harnessed and turned into valuable and marketable insights.
            As a homeowner I have received letters from potential buyers and
            real estate agents (acting on behalf of buyers) expressing interest
            in discussing the prospect of selling my house, even though I’ve not
        ...
        >
          ...
          <p>
            ...
            motivated buyers/renters and interested homeowners and
            commercialising that data.
          </p>
        </motion.section>
        <motion.section
          className="pt-24 py-6 xl:pt-40 xl:pb-6 max-w-xs md:max-w-3xl mx-auto relative"
